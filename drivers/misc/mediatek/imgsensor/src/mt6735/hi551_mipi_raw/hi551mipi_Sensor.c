...
static void sensor_init(void)
{
	...
	//====================================================================
	// sreg setting
	write_cmos_sensor(0x0B00, 0xE1D8);
	...
	write_cmos_sensor(0x0B1C, 0x1020);
...
write_cmos_sensor(0x0114, 0x0798); // y_output_size_h / l
	...
	write_cmos_sensor(0x0734, 0xf070); //140616 //AG max 16x, AG middle 8x	// 0x7030  max 8x middle 4x
...
static void preview_setting(void)
{
 ...
 write_cmos_sensor(0x0902, 0x4301); 	 // mipi_tx_op_mode1 / mipi_tx_op_mode2
 ...
 write_cmos_sensor(0x0012, 0x00BE); 	 // x_addr_start_hact_h / l 192 DPCOn(190,BE)
 write_cmos_sensor(0x0018, 0x0AE1); 	 // x_addr_end_hact_h / l 2783  DPCOn(2785,E1)
 write_cmos_sensor(0x0026, 0x002E); 	 // y_addr_start_vact_h / l 48  DPCOn(46,2E)
 write_cmos_sensor(0x002C, 0x07C9); 	 // y_addr_end_vact_h / l 1991  DPCOn(1991,7C9)
 write_cmos_sensor(0x0112, 0x0510); 	 // x_output_size_h / l 1296
 write_cmos_sensor(0x0114, 0x03CC); 	 // y_output_size_h / l 972
  write_cmos_sensor(0x0708, 0x0300);	  // dpc enable
 write_cmos_sensor(0x0118, 0x0100); 		 // Sleep Off
...
static void hs_video_setting()
{
	...
	write_cmos_sensor(0x0012, 0x00CE); // x_addr_start_hact_h / l
	write_cmos_sensor(0x0018, 0x0AD1);		// x_addr_end_hact_h / l 2769
	write_cmos_sensor(0x0026, 0x003A); // y_addr_start_vact_h / l
	write_cmos_sensor(0x002C, 0x07BD); // y_addr_end_vact_h / l
...
static void slim_video_setting()
{
 ...
 write_cmos_sensor(0x0700, 0xA0A3); 	 // byrscl_ctrl1 / byrscl_fifo_read_delay
 write_cmos_sensor(0x0012, 0x00CE); // x_addr_start_hact_h / l
 write_cmos_sensor(0x0018, 0x0AD1); // x_addr_end_hact_h / l 
 write_cmos_sensor(0x0026, 0x003A); // y_addr_start_vact_h / l
 write_cmos_sensor(0x002C, 0x07BD); // y_addr_end_vact_h / l
